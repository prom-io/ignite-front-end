...
const walletGenerationSuccessTranslations = {
    en: classes => (
        <span className={classes.content}>
            ...
            <br />
            <a>Please save</a> the wallet address and private key and keep them in a
            safe place.
        </span>
    ),
    kr: classes => (
        <span className={classes.content}>
            ...
            <br />
            <a> 지갑 주소</a>와 개인 키를 저장하여 안전한 곳에 보관하십시오.
        </span>
    )
};
...
const termsOfServiceAgreementTranslations = {
    en: () => (
        <span>
            ...
            <a href="/terms-and-policy" target="_blank" rel="noreferrer noopener">
                Terms of Use
            </a>{" "}
            and <a href="/terms-and-policy">Privacy Policy</a>.
        </span>
    ),
    kr: () => (
        <>
            ...
            과<a href="/terms-and-policy">개인정보 보호정책</a>을 읽고 이해했다.
        </>
    )
};
...
export const CreateWallet = observer(() => {
    ...
    return (
        ...
        >
            ...
            <p className={classes.content}>{l("sign-up.we-believe")}</p>
            <_Checkbox
