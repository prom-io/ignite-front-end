...
const walletGenerationSuccessTranslations = {
    en: classes => (
        <span className={classes.contentDescription}>
            ...
            We are making a record to the blockchain now. It can take some time, so
            please be patient. It is necessary to provide both security and anonymity
            to you with your new account.
        </span>
    ),
    kr: classes => (
        <span className={classes.contentDescription}>
...
export const CreateWalletPreload = observer(() => {
    ...
    const {
        ...
        genericAuthorizationDialogTempType
