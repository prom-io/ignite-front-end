    ...
    <>
      ...
      <DialogContent>
        <span className={classes.contentDescription}>
          ...
          You have to use a special ID named <a>blockchain wallet address</a> to sign up.
        </span>
        ...
        <div className={classes.contentBlock}>
          <div>
            <span>Use an existing wallet<br/>
            (for advanced users only)</span>
          </div>
        ...
        <div className={classes.notes}>
          <a>Note:</a> This option is suitable for blockchain experienced users only.
