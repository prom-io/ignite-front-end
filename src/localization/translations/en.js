export const en = {
    ...
    'sign-up.hash.verification.publish-record': 'Publish a record to Ethereum blockchain that contains the necessary hashcode and enter it’s Txn Hash here. We will create an Ignite account connected to that ETH wallet',
