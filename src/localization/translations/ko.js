export const ko = {
    ...
    'authorization.password-recovery.verification-is-needed': 'We need to verify that you really are the owner of the Ignite account, which password you forgot but trying to reclaim access to it.',
    ...
    'sign-up.generate-hash-code': 'Generate hash code',
    'sign-up.hash-code': 'A hash code for this password',
    'sign-up.hash-code.not-generated': 'Hash code not generated',
    'sign-up.hash-code.saved': 'I have saved the hash code to publish it later in a record in Ethereum blockchain',
