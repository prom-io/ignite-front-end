...
import { CommunityContainer } from "../Community/components";
...
const _CommunityPage = ({ currentUser }) => (
    <Grid container>
        <Grid item>
            <AppBar />
        </Grid>
...
export const CommunityPage = inject(mapMobxToProps)(observer(_CommunityPage));
